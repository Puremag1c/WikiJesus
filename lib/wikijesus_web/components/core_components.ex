defmodule WikijesusWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WikijesusWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WikijesusWeb.Gettext, "errors", msg, opts)
    end
  end
